...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().code(DEFAULT_CODE).name(DEFAULT_NAME).price(DEFAULT_PRICE);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().code(UPDATED_CODE).name(UPDATED_NAME).price(UPDATED_PRICE);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.code(UPDATED_CODE).name(UPDATED_NAME).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.code(UPDATED_CODE).name(UPDATED_NAME).price(UPDATED_PRICE);
